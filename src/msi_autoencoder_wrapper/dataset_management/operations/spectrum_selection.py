...
def select_merge_spectrum_ids(
    *,
    ...
    When both limits are supplied, the larger requested count is used and then
    capped by the number of available unannotated spectra.
    """
