...
# Submit the prepared predictive task array after the staging job has completed.
set -euo pipefail
...
printf '%s\n' "${job_id}" >"${RUN_DIRECTORY}/task-array-job-id"
echo "Submitted task array ${job_id} for campaign ${CAMPAIGN_ID}."
