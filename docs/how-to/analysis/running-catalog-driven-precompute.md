...
```bash
SETTINGS=assets/experiments/autoencoder_architecture/notebooks/17_09_26_metaspace_heads_vpu_contractive/analysis_settings.yaml
...
```bash
for NOTEBOOK in assets/experiments/autoencoder_architecture/notebooks/17_09_26_metaspace_heads_vpu_contractive/part_*.ipynb; do
  MPLCONFIGDIR=/tmp/msi-matplotlib UV_CACHE_DIR=/tmp/msi-uv-cache \
